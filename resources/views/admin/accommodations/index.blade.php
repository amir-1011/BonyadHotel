                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1 flex-wrap">
                            ...
                            <a wire:navigate href="{{ route('admin.halls.accommodation.index', $acc) }}" class="btn btn-xs btn-outline-info" style="padding:.2rem .5rem;font-size:.75rem;" title="سالن همایش"><i class="bi bi-building"></i></a>
