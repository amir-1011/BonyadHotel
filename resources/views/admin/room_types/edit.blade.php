...
<div class="card shadow-sm">
    <div class="card-header fw-bold d-flex align-items-center justify-content-between">
        ...
        <button class="btn btn-sm btn-success" type="button" data-bs-toggle="collapse" data-bs-target="#addRateForm">
    ...
    <div class="collapse @if($errors->hasBag('default') || old('price_per_night')) show @endif" id="addRateForm">
        <div class="card-body border-bottom bg-light">
            ...
            <form action="{{ route('admin.room-types.rates.store', [$accommodation, $roomType]) }}" method="POST">
                @csrf
                @include('admin.room_types._rate_form', ['rate' => null])
                <div class="mt-3">
                        ...
                        <td colspan="7" class="p-0">
                            <div class="collapse" id="editRate{{ $rate->id }}">
                                <div class="bg-light p-3 border-top">
                                    ...
                                    <form action="{{ route('admin.room-types.rates.update', [$accommodation, $roomType, $rate]) }}" method="POST">
                                        @csrf @method('PUT')
                                        @include('admin.room_types._rate_form', ['rate' => $rate])
                                        <div class="mt-3">
