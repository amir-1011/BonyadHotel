...
<div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    <div>
        ...
        <div class="text-muted small">
            <a href="{{ route('admin.room-types.index', $accommodation) }}"><i class="bi bi-chevron-right me-1"></i>بازگشت به اتاق‌ها</a>
            ...
            <div class="card-body p-4">
                @php
                    ...
                    for ($mi = 0; $mi < 3; $mi++) {
                        ...
                        $months[]  = ['label' => $jFirst->format('F Y'), 'firstDay' => $firstDay, 'lastDay' => $lastDay];
                    }
                @endphp
                ...
                <div class="mb-4">
                    ...
                    <div class="avail-calendar">
                        ...
                        <div class="avail-cal-cell {{ $cellClass }} {{ $isPast ? 'past' : '' }}"
                             title="{{ $dateStr }}@if($avail && $avail['is_blocked']) — مسدود@elseif($avail) — {{ $avail['available_rooms'] }} از {{ $avail['total'] }} اتاق آزاد@endif">
