...
<div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    <div>
        ...
        <div class="text-muted small mt-1">
            <a href="{{ route('admin.accommodations.index') }}"><i class="bi bi-chevron-right me-1"></i>بازگشت به اقامتگاه‌ها</a>
        </div>
    </div>
    <a href="{{ route('admin.room-types.create', $accommodation) }}" class="btn btn-success btn-sm">
...
<div class="card shadow-sm text-center py-5">
    ...
    <a href="{{ route('admin.room-types.create', $accommodation) }}" class="btn btn-success mt-2">تعریف اولین اتاق</a>
</div>
@else
<div class="row g-3">
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            ...
            <div class="card-footer bg-white d-flex gap-2 flex-wrap">
                <a href="{{ route('admin.room-types.edit', [$accommodation, $rt]) }}" class="btn btn-sm btn-outline-warning">
