        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ \App\Support\PdfPersian::toPersianDigits(number_format($data['guests'])) }}</td>
                    <td class="text-center text-danger fw-semibold">{{ \App\Support\PdfPersian::toPersianDigits(number_format($data['discount'])) }}</td>
                </tr>
                @endforeach
                <tr class="table-light fw-bold">
                    ...
                    <td class="text-center text-danger">{{ \App\Support\PdfPersian::toPersianDigits(number_format($totalDiscount)) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
