    ...
    <div>
        ...
        <nav aria-label="breadcrumb" class="mt-1">
            <ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a wire:navigate href="{{ route('host.dashboard') }}">داشبورد</a></li>
                <li class="breadcrumb-item"><a wire:navigate href="{{ route('host.accommodations.index') }}">اقامتگاه‌ها</a></li>
...
<div class="ta-card">
    <div class="ta-card__head">
        ...
        <a wire:navigate href="{{ route('host.bookings.index', ['accommodation_id' => $accommodation->id]) }}" class="btn btn-sm btn-outline-primary">مشاهده همه</a>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark small">{{ $b->bookerName() }}</span>
                        </td>
