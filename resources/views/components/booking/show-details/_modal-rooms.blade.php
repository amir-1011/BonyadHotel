...
<ul class="list-group list-group-flush">
    ...
    <li class="list-group-item d-flex justify-content-between px-0">
        ...
        <span>{{ $booking->roomRate->name }} · {{ \App\Support\PdfPersian::toPersianDigits(number_format($booking->roomRate->price_per_night)) }} ریال/شب/تخت</span>
    </li>
    @endif
</ul>
@else
...
@include('components.booking.show-details._add-room-form', [
    'booking' => $booking,
