    ...
    public function up(): void
    {
        ...
        HostPositionTitle::query()
            ...
            ->each(function (HostPositionTitle $position): void {
                $normalized = HostPermissions::backfillHallsGrants($position->host_panel_permissions);
        ...
        User::query()
            ...
            ->each(function (User $user): void {
                $normalized = HostPermissions::backfillHallsGrants($user->host_panel_permissions);
