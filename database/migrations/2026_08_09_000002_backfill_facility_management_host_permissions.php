    ...
    public function up(): void
    {
        ...
        HostPositionTitle::query()
            ...
            ->each(function (HostPositionTitle $position): void {
                $normalized = HostPermissions::backfillFacilityManagementGrants($position->host_panel_permissions);
        ...
        User::query()
            ...
            ->each(function (User $user): void {
                $normalized = HostPermissions::backfillFacilityManagementGrants($user->host_panel_permissions);
