    ...
    public function up(): void
    {
        ...
        HostPositionTitle::query()
            ...
            ->each(function (HostPositionTitle $position): void {
                $normalized = HostPermissions::backfillMedicalAccommodationGrants($position->host_panel_permissions);
        ...
        User::query()
            ...
            ->each(function (User $user): void {
                $normalized = HostPermissions::backfillMedicalAccommodationGrants($user->host_panel_permissions);
