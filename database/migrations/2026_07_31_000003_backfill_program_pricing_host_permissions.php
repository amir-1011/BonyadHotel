    ...
    public function up(): void
    {
        ...
        HostPositionTitle::query()
            ...
            ->each(function (HostPositionTitle $position): void {
                $normalized = HostPermissions::backfillGuestEditGrants($position->host_panel_permissions);
        ...
        User::query()
            ...
            ->each(function (User $user): void {
                $normalized = HostPermissions::backfillGuestEditGrants($user->host_panel_permissions);
