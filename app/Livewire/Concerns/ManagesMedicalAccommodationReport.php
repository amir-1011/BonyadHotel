...
trait ManagesMedicalAccommodationReport
{
    ...
    abstract protected function medicalAccommodationReportPanel(): string;

    abstract protected function medicalAccommodationReportRouteName(): string;

    public function mountMedicalAccommodationReport(): void
    {
        $now = Jalalian::now();
    ...
    protected function dashboardAccommodationFilterPageUrl(): string
    {
        ...
        return route($this->medicalAccommodationReportRouteName(), $query);
    }
    ...
    public function setPeriod(string $period): void
    {
        ...
        $this->period = $period;
        $this->closeModal();
        $this->dispatch('medical-report-map-refresh');
    }
    ...
    protected function renderMedicalAccommodationReport(MedicalAccommodationReportService $service)
    {
        ...
        return view('admin.medical-accommodation-report', array_merge($report, [
            'panel' => $this->medicalAccommodationReportPanel(),
